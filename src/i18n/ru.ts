...
const ru: LANG_MESSAGE = {
  ...
  outbound: 'Исходящий',
  airport: 'Аэропорт',
  nodeDetail: 'Детали узлов',
  airportWarnThreshold: 'Порог предупреждения о трафике',
  airportWarnHint:
    'Подсвечивает провайдера красным при превышении накопленного трафика (сбрасывается каждый цикл очистки). Пусто или 0 — отключено.',
  ...
  aggregateByAirport: 'По провайдеру',
